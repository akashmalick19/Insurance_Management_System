package com.example.demoInsuranceManagementPlatform.Util;
...
//    private static final int TOKEN_VALIDITY = 60;
    private static final int TOKEN_VALIDITY = 1200;
    ...
    public Boolean validateToken(String token, UserDetails userDetails) {
        final String clientEmail = getClientEmailFromToken(token);
